...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	public Position<E> addLast(E e) {
		...
		if (isEmpty()) {
			...
			// Sino, agregarlo despues del ultimo elemento
	...
	public Position<E> addBefore(Position<E> p, E e) throws IllegalArgumentException {
		// Si la lista esta vacio o p es el primero, agregarlo antes de p es lo mismo
		// que agregarlo al pricipio
		if (isEmpty() || p == first()) {
			return addFirst(e);
		} else {
			// sino, encuentro el elemento anterior a p y se agrega el nuevo despues de
			// este.
			Position<E> prev = before(p);
			return addAfter(prev, e);
		}
	}
