...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    /**
     * Retorna una nueva lista posicional con todos los elementos de la lista que est�n
     * despu�s del elemento e si right es true o de todos los elementos que est�n
     * antes de e si right es false
     * <p>
     * No incluye el elemento e, si el elemento e esta repetido en la lista tampoco lo incluye
     * Si el elemento e no se encuentra retorna una lista vac�a
     * <p>
     * Ejemplo:
     * <p>
     * lista = {Ana, Juan, Pedro, Sandra, Omar, Pedro, Andrea}
     * <p>
     * subList("Pedro", true) > {Sandra, Omar, Andrea}
     * subList("Pedro", false) > {Ana, Juan}
     * subList("Daniela", true) > {}
     */
    public LinkedPositionalList<E> subList(E e, boolean right) {
        //El primer test quedo en loop, el resto OK
        LinkedPositionalList<E> sublista = new LinkedPositionalList<>();
        Position<E> PosInicial = findPosition(e);

        if (PosInicial == null) {
            return sublista;
        }
        if (right) {
            Position<E> current = after(PosInicial);
            while (current != null) {
                if (current.getElement() != e) {
                    System.out.print(current.getElement());
                    sublista.addLast(current.getElement());
                    //   System.out.print(current.getElement() + "-");
        ...
        if (!right) {
            Position<E> current = before(PosInicial);
            LinkedPositionalList<E> temporal = new LinkedPositionalList<>();
            while (current != null) {
                if (current.getElement() != e) {
                    temporal.addFirst(current.getElement());
                    //  System.out.print(current.getElement() + "-");
                    current = before(current);
                }
            }

            for (Position<E> pos : temporal.positions()) {
                sublista.addLast(pos.getElement());
            }
            //System.out.println();
        }

        for (Position<E> pos : sublista.positions()) {
